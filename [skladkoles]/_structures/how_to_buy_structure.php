...
$page_title = $_BOOT->involve_object(
    ...
    ], $_AREA->{$C_E::_LANGUAGE}, $_AREA->{$C_E::_DIRECTORY}
);
?>
<!DOCTYPE html>
<html lang="ru">
...
<body>
    ...
    <div class="page mh htbuy">
        ...
        <div class="content gap htbuy">
            <div class="track-lane gaps to-right separated"><h1><?=$page_title?></h1></div>
            <div class="centered">
                <!--HOW_TO_BUY_GENERAL-->
                <?=$interlayers['how_to_buy_general']?>
                <!--/HOW_TO_BUY_GENERAL-->
                <!-- HOW_TO_BUY_SITE-->
                <!-- <?=$interlayers['how_to_buy_site']?> -->
                <!--/HOW_TO_BUY_SITE-->
                <!--HOW_TO_BUY_PHONE-->
                <!-- <?=$interlayers['how_to_buy_phone']?> -->
                <!--/HOW_TO_BUY_PHONE -->
            </div>
        </div>
    ...
    <script src="<?=$this->load_resource("javascript/modules/lightbox.js") ?>"></script>
