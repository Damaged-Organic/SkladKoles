...
<body>
    ...
    <div class="content gap contacts">
        <div class="track-lane gaps to-right separated"><h1><?=$page_title?></h1></div>
        <div id="map"></div>
        <!--CONTACTS-->
        <?=$interlayers['contacts']?>
        <!--/CONTACTS-->
        <!--FORM_FEEDBACK-->
        <?=$interlayers['form_feedback']?>
        <!--/FORM_FEEDBACK-->
        <div class="track-lane gaps"></div>
    </div>
    <div id="notifyPopUp" class="popUp notification">
    ...
    <script src="<?=$this->load_resource("javascript/modules/map.js") ?>"></script>
    ...
    <script>
        ...
        $(function(){
            ...
            app.basket.init();
            app.map.init();
            app.formProtocol.init($("#contactsForm"));
