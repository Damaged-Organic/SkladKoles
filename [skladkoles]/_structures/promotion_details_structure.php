...
<body>
    ...
    <div class="page mh">
        ...
        <div class="content gap saleDetailed" id="salePage">
            <section class="section">
                <!--SPECIAL_OFFERS_EXTENDED_DETAILS-->
                <?=$interlayers['special_offers_extended_details']?>
                <!--/SPECIAL_OFFERS_EXTENDED_DETAILS-->
            </section>
            <section class="section">
                <!--ITEMS_PROMO_SPECIFIC-->
                <?=$interlayers['items_promo_specific']?>
                <!--/ITEMS_PROMO_SPECIFIC-->
            </section>
            <section class="section">
                <!--ITEMS_VIEWED-->
            ...
            <?php if( !empty($interlayers['items_promo_specific']) || !empty($interlayers['items_viewed']) ): ?>
        ...
        $(function(){
            ...
            $(".counter").countdown({
                ...
                onTimeOut: function(el, finished){
                    if(finished) el.closest(".info").find("h2").text("ация завершена");
                }
            });
