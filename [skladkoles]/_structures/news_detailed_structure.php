...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
    ...
    <script>
        ...
        $(function(){
            ...
            var likeContainer = $("#social");
            likeContainer.on('popup_closed.social-likes', function(event, service){
                $(this).socialLikes({forceUpdate: true});
            });
...
<body>
    ...
    <div class="page">
        ...
        <div class="content gap">
            <div class="section">
                ...
                <!--NEWS_SINGLE-->
                <?=$interlayers['news_single']?>
                <!--/NEWS_SINGLE-->
            </div>
            <div class="section">
                <!--NEWS_RECENT-->
                <?=$interlayers['news_recent']?>
                <!--/NEWS_RECENT-->
    ...
    <script>
        ...
        $(function(){
            $("#social").on('popup_closed.social-likes', function(event, service){
                $(this).socialLikes({forceUpdate: true});
            });
