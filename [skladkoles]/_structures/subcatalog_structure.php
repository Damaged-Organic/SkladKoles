...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
    ...
    <?=$interlayers['head']?>
    <!--/HEAD-->
    <link rel="stylesheet" href="<?=$this->load_resource("css/jquery-ui.css") ?>">
...
<body>
    ...
    <div class="page">
        ...
        <div class="content gap catalog inside">
            ...
            <!--/CATALOG_SUBDIRECTORIES-->
            <div id="chosen-catalog" class="cell-view filter-open">
                <div class="view-panel">
                    <!--CATALOG_PANEL-->
                    <?=$interlayers['catalog_panel']?>
                    <!--/CATALOG_PANEL-->
                    <div class="auto-filter-result">
                        <!--CAR_BAR-->
                        <?=$interlayers['car_bar']?>
                        <!--/CAR_BAR-->
                    </div>
                ...
                <!--FILTERS_PANEL-->
                <?=$interlayers['filters_panel']?>
                <!--/FILTERS_PANEL-->
                <div class="grid">
                <!--ITEMS_LAYER-->
                <?=$interlayers['items_layer']?>
                <!--/ITEMS_LAYER-->
                </div>
            <!--PAGINATION-->
            <?=$interlayers['pagination']?>
            <!--/PAGINATION-->
        </div>
        </div>
        <div id="autoPopUp" class="popUp">
            <!--CARS_POPUP-->
            <?=$interlayers['cars_popup']?>
            <!--/CARS_POPUP-->
        </div>
        <div id="brandsPopUp" class="popUp">
            <!--BRANDS_POPUP-->
            <?=$interlayers['brands_popup']?>
            <!--/BRANDS_POPUP-->
        </div>
    ...
    <script src="<?=$this->load_resource("javascript/modules/custom.js") ?>"></script>
    <script src="<?=$this->load_resource("javascript/modules/catalog.js") ?>"></script>
    ...
    <script src="<?=$this->load_resource("javascript/modules/historyFilter.js") ?>"></script>
    <script src="<?=$this->load_resource("javascript/formProtocol.js") ?>"></script>
