...
$interworkers = [
    ...
    'obtain_item_spares'     => $this->load_inter('worker', 'obtain_item_spares'/*, $_AREA->{$C_E::_ARGUMENTS}[0]*/),
...
$interlayers = [
    ...
    'item_spares'                 => $this->load_inter('layer', 'item_spares',
                                        $interworkers['obtain_item_spares']
                                     ),
