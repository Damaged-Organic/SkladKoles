...
if( !empty($supplied_data['item_head_data']) ) {
    $title       = $supplied_data['item_head_data']['title'];
    $description = $supplied_data['item_head_data']['description'];
} else {
...
<meta property="og:title" content="Sklad Koles">
...
<link rel="stylesheet" href="<?=$this->load_resource("css/new/stabilizer.css") ?>">
<link rel="stylesheet" href="<?=$this->load_resource("css/new/common.css") ?>">
<link rel="stylesheet" href="<?=$this->load_resource("css/new/main.css") ?>">
