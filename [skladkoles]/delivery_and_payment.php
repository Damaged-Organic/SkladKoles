...
$interworkers = [
    ...
    'payment_types'          => $this->load_inter('worker', 'payment_types'),
...
$interlayers = [
    ...
    'payment_types'               => $this->load_inter('layer', 'payment_types',
                                        $interworkers['payment_types']
                                     ),
    ...
    'delivery_information'        => $this->load_inter('layer', 'delivery_information'),
