...
$entity_content = array(
    $C_S::DB_PREFIX_alpha.'intro_about_content' => array($_AREA->{$C_E::_LANGUAGE})
);

$entity_tables_fields = array(
    $C_S::DB_PREFIX_alpha.'intro_about'         => array('id', 'record_order', 'icon'),
    $C_S::DB_PREFIX_alpha.'intro_about_content' => array('title', 'text')
);
